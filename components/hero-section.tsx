...
export function HeroSection() {
  return (
    <section
      className="flex flex-col items-center relative mx-auto rounded-2xl overflow-hidden my-6 py-0 px-4
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 mt-16 md:mt-[120px] lg:mt-[160px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-5 lg:space-y-6 text-center lg:text-left">
            ...
            <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto lg:mx-0">
              Block distracting apps and websites, boost your productivity, and reclaim your focus with our intelligent
              app blocking solution.
            </p>
          ...
          <div className="hidden lg:flex justify-center items-center">
            <div className="w-64 h-96 bg-gradient-to-br from-primary/20 to-primary-dark/20 rounded-3xl border border-primary/30 flex items-center justify-center">
              <div className="text-primary/60 text-center">
                ...
                <p className="text-sm font-medium">Phone Mockup</p>
